...
<body>
    ...
    <c:if test="${pageContext.request.userPrincipal.name != null}">
        <h2 style="padding-left: 10px">
            Welcome to Retailer Section <a class="logt"
    ...
    <li><div class="title__action"><a href="client/viewProducts" class="btn btn-primary">View Products</a> </div></li>
    <li><div class="title__action"><a href="client/viewCompanyList" class="btn btn-primary">View Company List</a></div></li>
    <li><div class="title__action"><a href="client/viewChemicalList" class="btn btn-primary">View Chemical List</a></div></li>
    </ul>
</body>
</html>